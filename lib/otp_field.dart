...
import 'my_otp_field_style.dart';
import 'style.dart';
...
class _OTPTextFieldState extends State<OTPTextField> {
  ...
  late List<TextField?> _textFields;
  ...
  void initState() {
    ...
    _textFields = List<TextField?>.filled(widget.length, null, growable: false);
    ...
    return SizedBox(
      ...
      child: Row(
        ...
        children: List.generate(widget.length, (index) {
          return buildTextField(context, index, widget.length);
        }),
      ),
    );
  }
  ...
  Widget buildTextField(BuildContext context, int index, int length) {
    ...
    if (focusNode == null) {
      ...
      focusNode?.onKey = (node, event) {
        ...
        if (event.isKeyPressed(LogicalKeyboardKey.backspace)) {
          if (_textFields[index] != null) {
            _textFields[index]?.onChanged?.call("");
          }
        }
    ...
    if (_textFields[index] == null) {
      _textFields[index] = tempTextField;
    }
